...
public class CS2420Class {
	...
	public ArrayList<CS2420Student> lookup(EmailAddress contactInfo) {
		ArrayList<CS2420Student> returnList = new ArrayList<CS2420Student>();
	...
	public ArrayList<EmailAddress> getContactList() {
		ArrayList<EmailAddress> returnList = new ArrayList<EmailAddress>();
		if(this.studentList.isEmpty()) {
			return returnList;
		}
		returnList.add(this.studentList.get(0).getContactInfo());
		for(CS2420Student s: this.studentList) 
		{
